...
import { uploadContractorAgreementFile } from '@/lib/contractor-agreements/service';
...
export async function POST(
  ...
  try {
    ...
    const agreement = await uploadContractorAgreementFile({
      agreementId: id,
      file,
      kind: 'signed',
    ...
    await createAuditLog({
      ...
      description: 'Uploaded contractor-signed agreement copy',
      metadata: {
    ...
    console.error('Error uploading contractor signed agreement:', error);
