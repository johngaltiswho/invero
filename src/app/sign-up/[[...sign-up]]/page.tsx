          ...
          <SignUp 
            appearance={{
              elements: {
                ...
                formButtonPrimary: "w-full bg-accent-orange hover:bg-orange-600 text-white font-medium py-3 px-4 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-accent-orange focus:ring-offset-2 focus:ring-offset-neutral-dark",
                ...
                otpCodeFieldInput: "bg-neutral-medium border border-neutral-medium text-primary rounded-lg focus:outline-none focus:ring-2 focus:ring-accent-orange focus:border-accent-orange",
                otpCodeFieldInputBox: "bg-neutral-medium border border-neutral-medium text-primary rounded-lg focus-within:ring-2 focus-within:ring-accent-orange focus-within:border-accent-orange",
