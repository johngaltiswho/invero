          ...
          <div className="flex items-center justify-between md:hidden">
            <div className="flex items-center gap-3">
              <button
                ...
                className="inline-flex items-center justify-center w-9 h-9 rounded-lg border border-neutral-medium text-secondary hover:text-primary hover:border-accent-amber/40 transition-colors"
            ...
            <div className="relative flex items-center gap-3">
              ...
              >
                <div className="w-8 h-8 bg-accent-amber rounded-full flex items-center justify-center text-primary font-bold text-xs">
